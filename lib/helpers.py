...
#--Armor
    ...
    # print_centered(selected_armor, width)
    #end of original
    ...
    print()
    selected_armor_name = get_user_input([armor.name for armor in user_session.query(Armor).all()])
